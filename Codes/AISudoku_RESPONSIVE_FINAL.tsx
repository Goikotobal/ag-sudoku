...
export default function AISudoku() {
    ...
    useEffect(() => {
        const checkDesktop = () => {
            setIsDesktop(window.innerWidth >= 1400) // 🔥 LARGE PHONES STAY RESPONSIVE!
        }
    ...
    const renderHeader = () => (
        <div
            style={{
                ...
                maxWidth: isDesktop ? "100%" : "calc(100% - 16px)", // 🔥 MOBILE: Match board width
                width: isDesktop ? "100%" : "calc(100% - 16px)",
                margin: isDesktop ? "0" : "0 auto", // 🔥 MOBILE: Center it
                marginBottom: isDesktop ? 4 : 4, // Preserve marginBottom
            }}
        >
            {/* Left: Logo + Title */}
            <div
    ...
    const renderStats = () => (
        <div
            style={{
                ...
                gap: isDesktop ? 4 : 2, // 🔥 MOBILE: Tighter
                marginBottom: isDesktop ? 0 : 4, // 🔥 MOBILE: Space to difficulty selector!
                maxWidth: isDesktop ? "100%" : "calc(100% - 16px)", // 🔥 MOBILE: Match board width
                width: isDesktop ? "100%" : "calc(100% - 16px)",
                margin: isDesktop ? "0" : "0 auto", // 🔥 MOBILE: Center it
                marginBottom: isDesktop ? 4 : 4, // Preserve marginBottom
    ...
    const renderDifficultySelector = () => (
        <div
            style={{
                ...
                width: isDesktop ? "100%" : "calc(100% - 16px)",
                margin: isDesktop ? "0" : "0 auto", // 🔥 MOBILE: Center it
                marginBottom: isDesktop ? 4 : 8, // 🔥 MOBILE: Space to board!
            }}
        >
    ...
    const renderSudokuGrid = () => (
        <div
            style={{
                ...
                maxWidth: isDesktop ? "600px" : "calc(100% - 16px)", // 🔥 MOBILE: Full width with margins!
                width: isDesktop ? "600px" : "calc(100% - 16px)",
                margin: "0 auto", // Center on both mobile and desktop
                marginTop: isDesktop ? 2 : 8, // 🔥 MOBILE: Space from difficulty buttons!
                marginBottom: isDesktop ? 4 : 8, // 🔥 MOBILE: Space to number pad!
            }}
        >
        ...
        <>
            ...
            <div
                style={{
                    ...
                    marginBottom: isDesktop ? 4 : 6, // 🔥 SPACE TO CONTROL BUTTONS!
                    opacity: isPaused || isAISolving ? 0.5 : 1,
                    pointerEvents:
                        isPaused || isAISolving ? "none" : "auto",
                    transition: "opacity 0.3s ease",
                    maxWidth: isDesktop ? "600px" : "calc(100% - 16px)", // 🔥 MATCH BOARD WIDTH!
                    width: isDesktop ? "600px" : "calc(100% - 16px)",
                    margin: "0 auto", // Center like board
                }}
            >
                    ...
                    return (
                        <button
                            ...
                            style={{
                                ...
                                cursor: isComplete
                                    ? "not-allowed"
                                    : "pointer",
                                fontSize: isDesktop ? "16px" : "clamp(12px, 3vw, 16px)", // 🔥 SMALLER!
                                fontWeight: 700,
                                ...
                                alignItems: "center",
                                gap: 1,
                                minHeight: isDesktop ? "40px" : "28px", // 🔥 MUCH SHORTER!
                                touchAction: "manipulation",
                        ...
                        >
                            ...
                            {num !== 0 && (
                                <span
                                    style={{
                                        fontSize: isDesktop ? "8px" : "clamp(6px, 1.4vw, 7px)", // 🔥 TINY!
                                        fontWeight: 500,
                                        color:
                                            remaining === 0
                                                ? "#cbd5e0"
            ...
            <div style={{ marginBottom: isDesktop ? 6 : 15 }} /> {/* 🔥 MOBILE: 15px gap to show aurora (more compact) */}
    ...
    return (
        <div
            style={{
                ...
                display: "flex",
                flexDirection: "column",
                padding: isDesktop ? "0.5rem" : "8px", // 🔥 DESKTOP: Less padding to move up!
                paddingTop: isDesktop ? "0.3rem" : "max(8px, env(safe-area-inset-top))", // 🔥 DESKTOP: Minimal top padding!
                paddingBottom: isDesktop ? "1rem" : "max(8px, env(safe-area-inset-bottom))",
                boxSizing: "border-box",
                position: "relative",
            }}
        >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
                ...
                {isDesktop ? (
                    // 🖥️ DESKTOP: Just Game (Board + Controls) - NO Profile Panel
                    <div
                        style={{
                            display: "flex",
                            justifyContent: "center",
                    ...
                    >
                        <div
                            style={{
                                display: "grid",
                                gridTemplateColumns: "auto auto", // Fit content
                    ...
                    // 📱 MOBILE/TABLET VERTICAL LAYOUT - Centered 85% Container
                    <div style={{
                        maxWidth: "90%",
                        width: "90%",
                        margin: "0 auto",
