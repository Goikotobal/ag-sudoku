    ...
    const renderSudokuGrid = () => (
        <div
            style={{
                ...
                maxWidth: isDesktop ? "500px" : "100%", // Reduced from 700px to 500px
                    ...
                    return (
                        <div
                            ...
                            style={{
                                ...
                                alignItems: "center",
                                justifyContent: "center",
                                fontSize: isDesktop ? 24 : 20, // Reduced from 32 to 24 for smaller board
                                fontWeight: 700,
                                cursor: "pointer",
                                color: isGiven
                                    ? "#2d3748"
        ...
        <>
            ...
            <div
                style={{
                    ...
                    gap: isDesktop ? 6 : 4, // More gap on desktop
                    marginBottom: 6,
                ...
                {[1, 2, 3, 4, 5, 6, 7, 8, 9, 0].map((num) => {
                    ...
                    return (
                        <button
                            ...
                            disabled={isComplete}
                            style={{
                                padding: isDesktop ? "12px 8px" : "6px 4px",
                                ...
                                cursor: isComplete
                                    ? "not-allowed"
                                    : "pointer",
                                fontSize: isDesktop ? "22px" : "clamp(16px, 4vw, 20px)",
                                fontWeight: 700,
            ...
            <div style={{ marginBottom: isDesktop ? 6 : 32 }} /> {/* Increased from 16 to 32 */}
