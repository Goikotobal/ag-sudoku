...
export default function AISudoku() {
    ...
    const renderSudokuGrid = () => (
        <div
            style={{
                ...
                maxWidth: isDesktop ? "700px" : "98%", // 🔥 MOBILE: Use 98% of screen width!
                width: isDesktop ? "700px" : "98%",
                    ...
                    return (
                        <div
                            ...
                            style={{
                                ...
                                alignItems: "center",
                                justifyContent: "center",
                                fontSize: isDesktop ? 32 : "clamp(24px, 6vw, 32px)", // 🔥 MOBILE: Much bigger numbers!
                                fontWeight: 700,
                                cursor: "pointer",
                                color: isGiven
                                    ? "#2d3748"
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    style={{
                                                        ...
                                                        justifyContent:
                                                            "center",
                                                        fontSize: isDesktop ? "10px" : "clamp(9px, 2.2vw, 12px)", // 🔥 MOBILE: Bigger notes
                                                        fontWeight: 600,
                                                        color: hasNote
                                                            ? isHighlighted
                                                                ? "#ffffff"
    ...
    const renderControls = () => (
        <>
                ...
                {[1, 2, 3, 4, 5, 6, 7, 8, 9, 0].map((num) => {
                    ...
                    return (
                        <button
                            ...
                            disabled={isComplete}
                            style={{
                                padding: isDesktop ? "12px 8px" : "10px 4px", // 🔥 More padding on mobile
                                ...
                                cursor: isComplete
                                    ? "not-allowed"
                                    : "pointer",
                                fontSize: isDesktop ? "22px" : "clamp(22px, 5.5vw, 28px)", // 🔥 MOBILE: Much bigger numbers!
                                fontWeight: 700,
                                ...
                                alignItems: "center",
                                gap: 1,
                                minHeight: isDesktop ? "56px" : "54px", // 🔥 MOBILE: Taller buttons for better tapping
                                touchAction: "manipulation",
            ...
            {/* Notes Toggle & Action Buttons - 2x2 Grid */}
            <div
                style={{
                    display: "grid",
            ...
            >
                ...
                <button
                    onClick={solvePuzzle}
                    disabled={
                        !rules.aiSolve || isAISolving || hintsRemaining > 0
                    }
                    style={{
                        padding: isDesktop ? "14px 12px" : "10px 8px",
                        border: "none",
    ...
    return (
        ...
        >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
                ...
                {isDesktop ? (
                    // 🖥️ DESKTOP LANDSCAPE LAYOUT - Centered & Spacious
                    <div
                        style={{
                            display: "flex",
                            justifyContent: "center",
                            alignItems: "center",
                            minHeight: "calc(100vh - 160px)", // Vertically center remaining space
                            padding: "1rem 2rem",
                        }}
                    >
                        <div
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            <div style={{ textAlign: "left", flex: 1 }}>
                                ...
                                <div style={{
                                    ...
                                    Row {hintExplanation.cell.row + 1}, Column {hintExplanation.cell.col + 1}
                                </div>
                            </div>
                            <div style={{
                                width: 60,
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                📚 Technique: {hintExplanation.technique}
                            </div>
                        </div>
                        ...
                        {/* Updated Legend - explains what will happen */}
                        <div style={{
                            background: "#f8fafc",
                            padding: 12,
                            borderRadius: 10,
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: 6, fontSize: 12 }}>
                                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                                    ...
                                    <span style={{ color: "#64748b" }}>Yellow cell will show where <strong>{hintExplanation.value}</strong> was placed</span>
                                </div>
                                {hintExplanation.conflictingCells && hintExplanation.conflictingCells.length > 0 && (
                                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                                        ...
                                        <span style={{ color: "#64748b" }}>Red cells will show blocking numbers</span>
                                    </div>
                                )}
                                <div style={{ 
                                    color: "#10b981", 
                                    ...
                                    💡 Highlights will stay for 3 seconds so you can study them!
                                </div>
                            </div>
                        </div>
