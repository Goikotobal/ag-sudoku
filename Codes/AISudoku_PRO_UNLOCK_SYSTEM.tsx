...
export default function AISudoku() {
    ...
    useEffect(() => {
        const checkDesktop = () => {
            setIsDesktop(window.innerWidth >= 1000) // Changed from 768 to 1000
        }
    ...
    const renderHeader = () => (
        <div
            style={{
                ...
                marginBottom: isDesktop ? 0 : 1, // 🔥 DESKTOP: Tighter to fit 100% zoom!
                justifyContent: "space-between",
                maxWidth: isDesktop ? "100%" : "90%", // 🔥 MOBILE: Match board width
                width: isDesktop ? "100%" : "90%",
                margin: isDesktop ? "0" : "0 auto", // 🔥 MOBILE: Center it
                marginBottom: isDesktop ? 4 : 1, // Preserve marginBottom
            }}
        >
            {/* Left: Logo + Title */}
            <div
    ...
    const renderSudokuGrid = () => (
        <div
            style={{
                ...
                maxWidth: isDesktop ? "600px" : "95%", // 🔥 MOBILE: MASSIVE BOARD!
                width: isDesktop ? "600px" : "95%",
                margin: "0 auto", // Center on both mobile and desktop
                marginBottom: isDesktop ? 1 : 2, // 🔥 DESKTOP: Minimal margin!
            }}
        >
        ...
        <>
            ...
            <div
                style={{
                    ...
                    marginBottom: isDesktop ? 4 : 1.5, // 🔥 MINIMAL!
