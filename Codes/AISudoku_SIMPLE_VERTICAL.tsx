    ...
    const renderHeader = () => (
        <div
            style={{
                ...
                maxWidth: "100%", // 🔥 MOBILE: Match board width
                width: "100%",
        ...
        <>
            ...
            <div
                style={{
                    ...
                    maxWidth: "100%", // 🔥 MATCH BOARD WIDTH!
                    width: "100%",
    ...
    return (
        <div
            style={{
                ...
                display: "flex",
                flexDirection: "column",
                alignItems: "center", // 🔥 CENTER HORIZONTALLY ONLY!
        ...
        >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
                ...
                {/* 🎯 UNIVERSAL VERTICAL LAYOUT - Works on ALL devices! */}
                <div style={{
                    maxWidth: isDesktop ? "700px" : "90%", // 🔥 Desktop: 700px max, Mobile: 90%
