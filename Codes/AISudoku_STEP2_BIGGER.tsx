    ...
    const renderSudokuGrid = () => (
        <div
            style={{
                ...
                maxWidth: isDesktop ? "680px" : "85%", // 🔥 DESKTOP: HUGE board!
                width: isDesktop ? "680px" : "85%",
    ...
    const renderControls = () => (
        <>
            ...
            >
                ...
                >
                    <span style={{ fontSize: isDesktop ? "18px" : "16px" }}>✏️</span>
                ...
                >
                    <span style={{ fontSize: isDesktop ? "18px" : "16px" }}>{isPaused ? "▶️" : "⏸️"}</span>
                    <span style={{ fontSize: isDesktop ? "11px" : "clamp(9px, 2.2vw, 10px)" }}> {/* 🔥 BIGGER! */}
                ...
                >
                    <span style={{ fontSize: isDesktop ? "18px" : "16px" }}>💡</span>
                    <span style={{ fontSize: isDesktop ? "11px" : "clamp(9px, 2.2vw, 10px)" }}> {/* 🔥 BIGGER! */}
                        {rules.hints === 0
                            ? "None"
                            : hintsRemaining === 0
