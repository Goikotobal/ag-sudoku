    ...
    const renderHeader = () => (
        <div
            style={{
                ...
                maxWidth: isDesktop ? "100%" : "94%", // 🔥 MOBILE: Match board width
                width: isDesktop ? "100%" : "94%",
    ...
    const renderSudokuGrid = () => (
        <div
            style={{
                ...
                width: isDesktop ? "600px" : "94%", // 🔥 VW UNITS!
                margin: "0 auto",
        ...
        <>
            ...
            <div
                style={{
                    ...
                    maxWidth: isDesktop ? "600px" : "94%", // 🔥 MATCH BOARD WIDTH!
                    width: isDesktop ? "600px" : "94%",
                    ...
                    return (
                        <button
                            ...
                            style={{
                                ...
                                cursor: isComplete
                                    ? "not-allowed"
                                    : "pointer",
                                fontSize: isDesktop ? "22px" : "clamp(18px, 4vw, 22px)", // 🔥 BIGGER!
                                fontWeight: 700,
                        ...
                        >
                            ...
                            {num !== 0 && (
                                <span
                                    style={{
                                        fontSize: isDesktop ? "12px" : "clamp(10px, 2.2vw, 12px)", // 🔥 READABLE!
    ...
    return (
        <div
            style={{
                ...
                paddingLeft: isDesktop ? "0.5rem" : "3%", // 🔥 3% SIDE MARGINS!
                paddingRight: isDesktop ? "0.5rem" : "3%", // 🔥 3% SIDE MARGINS!
                boxSizing: "border-box",
                position: "relative",
            }}
        >
