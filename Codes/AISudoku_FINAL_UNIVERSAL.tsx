    ...
    const renderHeader = () => (
        <div
            style={{
                ...
                maxWidth: isDesktop ? "100%" : "calc(100vw - 16px)", // 🔥 MOBILE: Match board width
                width: isDesktop ? "100%" : "calc(100vw - 16px)",
    ...
    const renderSudokuGrid = () => (
        <div
            style={{
                ...
                width: isDesktop ? "600px" : "calc(100vw - 16px)", // 🔥 VW UNITS!
                margin: "0 auto",
                marginTop: isDesktop ? 2 : 2,
        ...
        <>
            ...
            <div
                style={{
                    ...
                    maxWidth: isDesktop ? "600px" : "calc(100vw - 16px)", // 🔥 MATCH BOARD WIDTH!
    ...
    return (
        <div
            style={{
                ...
                padding: isDesktop ? "0.5rem" : "0", // 🔥 NO PADDING ON MOBILE!
                ...
                paddingLeft: isDesktop ? "0.5rem" : "8px", // 🔥 HORIZONTAL PADDING!
                paddingRight: isDesktop ? "0.5rem" : "8px", // 🔥 HORIZONTAL PADDING!
                boxSizing: "border-box",
                position: "relative",
            }}
        >
