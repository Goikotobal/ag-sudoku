    ...
    const renderHeader = () => (
        <div
            style={{
                ...
                marginBottom: isDesktop ? 4 : 0, // Preserve marginBottom
            }}
        >
            {/* Left: Logo + Title */}
            <div
    ...
    const renderSudokuGrid = () => (
        <div
            style={{
                ...
                maxWidth: isDesktop ? "500px" : "none", // 🔥 MOBILE: No max!
                width: isDesktop ? "500px" : "100%",
                margin: "0 auto",
                marginTop: isDesktop ? 2 : 0, // 🔥 MOBILE: No top margin!
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
                ...
                {isDesktop ? (
                    ...
                    <div style={{
                        ...
                        padding: "0 4px", // 🔥 Just tiny padding for safety
                        boxSizing: "border-box",
                        display: "flex",
                        flexDirection: "column",
                        gap: "0", // 🔥 NO GAP!
