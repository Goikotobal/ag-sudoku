...
export default function AGSudoku() {
    ...
    const [profile, setProfile] = useState(() => {
        const saved = localStorage.getItem("sudokuProfile")
        return saved
            ? JSON.parse(saved)
            : {
                  nickname: "Player",
    ...
    return (
        ...
        >
            ...
            {/* VICTORY MODAL with Avatar Celebration */}
            {gameWon && (
                <>
                    <Confetti />
                    <div
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {profile.nickname} conquered the puzzle!
                                </div>
                                <div
                                    style={{
                                        color: "white",
                                ...
                                >
                                    Difficulty: {difficulty} • Mistakes:{" "}
                                    {mistakes}/{maxMistakes}
                                </div>
                            </div>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {profile.nickname} ran out of chances!
                            </div>
                            <div
                                style={{
                                    color: "white",
                            ...
                            >
                                Time played: {formatTime(timer)} • Difficulty:{" "}
                                {difficulty}
                            </div>
                        </div>
