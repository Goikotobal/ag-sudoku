    ...
    const renderHeader = () => (
        <div
            style={{
                ...
                marginBottom: isDesktop ? 4 : 1, // 🔥 MOBILE: Minimal margin
                justifyContent: "space-between",
                maxWidth: isDesktop ? "100%" : "85%", // 🔥 MOBILE: Match board width
        ...
        >
            ...
            >
                <img
                    ...
                    alt="AG Logo"
                    style={{
                        height: isDesktop ? 32 : 24, // 🔥 MOBILE: Smaller
                        width: "auto",
                        objectFit: "contain",
    ...
    const renderStats = () => (
        <div
            style={{
                ...
                marginBottom: isDesktop ? 4 : 1, // 🔥 MOBILE: Minimal
                maxWidth: isDesktop ? "100%" : "85%", // 🔥 MOBILE: Match board width
                width: isDesktop ? "100%" : "85%",
                margin: isDesktop ? "0" : "0 auto", // 🔥 MOBILE: Center it
                marginBottom: isDesktop ? 4 : 1, // Preserve marginBottom
        ...
        >
            ...
            {["medium", "expert", "pro"].map((diff) => (
                <button
                    ...
                    style={{
                        flex: 1,
                        padding: isDesktop ? "8px 6px" : "6px 4px", // 🔥 MOBILE: Shorter!
                        border: "none",
                        background:
                        ...
                        fontWeight: 600,
                        fontSize: isDesktop ? "13px" : "clamp(11px, 2.8vw, 12px)", // 🔥 MOBILE: Smaller
                        color:
                            currentDifficulty === diff
                                ? "white"
                                : "#4a5568",
                        ...
                        minHeight: isDesktop ? "38px" : "32px", // 🔥 MOBILE: Much shorter!
    ...
    const renderSudokuGrid = () => (
        <div
            style={{
                ...
                maxWidth: isDesktop ? "500px" : "85%", // 🔥 MOBILE: 85% for compact fit
                width: isDesktop ? "500px" : "85%",
                margin: "0 auto", // Center on both mobile and desktop
                marginBottom: isDesktop ? 6 : 2, // 🔥 MOBILE: Minimal margin
            }}
        >
                    ...
                    return (
                        <div
                            ...
                            style={{
                                ...
                                alignItems: "center",
                                justifyContent: "center",
                                fontSize: isDesktop ? 24 : "clamp(16px, 4vw, 22px)", // 🔥 MOBILE: Compact sizing
                                fontWeight: 700,
                                cursor: "pointer",
                                color: isGiven
                                    ? "#2d3748"
        ...
        <>
            ...
            <div
                style={{
                    ...
                    gap: isDesktop ? 6 : 2, // 🔥 MOBILE: Very tight gap (still shows aurora!)
                    marginBottom: isDesktop ? 6 : 2, // 🔥 MOBILE: Minimal margin
                ...
                {[1, 2, 3, 4, 5, 6, 7, 8, 9, 0].map((num) => {
                    ...
                    return (
                        <button
                            ...
                            disabled={isComplete}
                            style={{
                                padding: isDesktop ? "12px 8px" : "5px 3px", // 🔥 MOBILE: Very compact
                                ...
                                cursor: isComplete
                                    ? "not-allowed"
                                    : "pointer",
                                fontSize: isDesktop ? "22px" : "clamp(16px, 4vw, 20px)", // 🔥 MOBILE: Compact
                                fontWeight: 700,
                                ...
                                alignItems: "center",
                                gap: 1,
                                minHeight: isDesktop ? "56px" : "38px", // 🔥 MOBILE: Shorter
                                touchAction: "manipulation",
            ...
            <div style={{ marginBottom: isDesktop ? 6 : 10 }} /> {/* 🔥 MOBILE: 10px gap to show aurora (very compact) */}

            {/* Pause + Notes - SIDE BY SIDE to save space */}
            <div
                style={{
                    display: "grid",
            ...
            >
                ...
                <button
                    ...
                    style={{
                        ...
                        cursor: isAISolving ? "not-allowed" : "pointer",
                        fontWeight: 600,
                        fontSize: isDesktop ? "13px" : "clamp(11px, 2.8vw, 12px)",
                        transition: "all 0.2s",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
            ...
            {/* Hints + New Game + Undo + AI Solve - 4 BUTTONS IN A ROW */}
            <div
                style={{
                    display: "grid",
            ...
            >
                ...
                <button
                    ...
                    style={{
                        padding: isDesktop ? "10px 6px" : "8px 4px",
                        border: "none",
                        borderRadius: 8,
                        cursor:
                            rules.hints === 0 ||
                            ...
                            isAISolving
                                ...
                                : "pointer",
                        fontWeight: 600,
                        fontSize: isDesktop ? "12px" : "clamp(10px, 2.5vw, 11px)",
                        background:
                            "linear-gradient(135deg, #a855f7 0%, #ec4899 100%)",
                        color: "white",
                        opacity:
                ...
                >
                    <span>💡</span>
                    <span style={{ fontSize: isDesktop ? "10px" : "clamp(8px, 2vw, 9px)" }}>
                        {rules.hints === 0
                            ? "None"
                            : hintsRemaining === 0
                              ? "None"
                ...
                >
                    <span>🎮</span>
                    <span style={{ fontSize: isDesktop ? "10px" : "clamp(8px, 2vw, 9px)" }}>New</span>
                </button>

                {/* Undo Button */}
                <button
                    onClick={undo}
                    disabled={!rules.undo || moveHistory.length === 0 || isAISolving}
                    style={{
                        padding: isDesktop ? "10px 6px" : "8px 4px",
                        border: "2px solid #e2e8f0",
                        borderRadius: 8,
                        cursor:
                            !rules.undo || moveHistory.length === 0 || isAISolving
                                ? "not-allowed"
                                : "pointer",
                        fontWeight: 600,
                        fontSize: isDesktop ? "12px" : "clamp(10px, 2.5vw, 11px)",
                ...
                >
                    <span>↶</span>
                    <span style={{ fontSize: isDesktop ? "10px" : "clamp(8px, 2vw, 9px)" }}>Undo</span>
                </button>

                {/* AI Solve / Disabled */}
                <button
                    onClick={aiSolve}
                    disabled={!rules.aiSolve || isAISolving}
                    style={{
                        padding: isDesktop ? "10px 6px" : "8px 4px",
                        border: "2px solid #e2e8f0",
                        borderRadius: 8,
                        cursor: !rules.aiSolve || isAISolving ? "not-allowed" : "pointer",
                        fontWeight: 600,
                        fontSize: isDesktop ? "12px" : "clamp(10px, 2.5vw, 11px)",
                        background: "white",
                        color: "#4a5568",
                        opacity: !rules.aiSolve || isAISolving ? 0.3 : 1,
                        touchAction: "manipulation",
                        minHeight: isDesktop ? "44px" : "38px",
                        display: "flex",
                        flexDirection: "column",
    ...
    return (
        <div
            style={{
                ...
                display: "flex",
                flexDirection: "column",
                padding: isDesktop ? "1rem" : "8px", // Less padding on desktop
                paddingTop: isDesktop ? "1rem" : "max(8px, env(safe-area-inset-top))",
