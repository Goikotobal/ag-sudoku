    ...
    const renderSudokuGrid = () => (
        <div
            style={{
                ...
                maxWidth: isDesktop ? "600px" : "90%", // 🔥 DESKTOP: Fits screen! MOBILE: HUGE!
        ...
        <>
                ...
                {[1, 2, 3, 4, 5, 6, 7, 8, 9, 0].map((num) => {
                    ...
                    return (
                        <button
                            ...
                            disabled={isComplete}
                            style={{
                                padding: isDesktop ? "8px 6px" : "4px 2px", // 🔥 SMALLER!
                                ...
                                cursor: isComplete
                                    ? "not-allowed"
                                    : "pointer",
                                fontSize: isDesktop ? "18px" : "clamp(14px, 3.5vw, 18px)", // 🔥 SMALLER!
                                fontWeight: 700,
                                ...
                                alignItems: "center",
                                gap: 1,
                                minHeight: isDesktop ? "48px" : "34px", // 🔥 SHORTER!
                                touchAction: "manipulation",
                        ...
                        >
                            ...
                            {num !== 0 && (
                                <span
                                    style={{
                                        fontSize: isDesktop ? "9px" : "clamp(7px, 1.6vw, 8px)", // 🔥 SMALLER!
                                        fontWeight: 500,
                                        color:
                                            remaining === 0
                                                ? "#cbd5e0"
            ...
            >
                ...
                <button
                    ...
                    disabled={isAISolving}
                    style={{
                        padding: isDesktop ? "12px 8px" : "10px 6px", // 🔥 BIGGER!
                        border: "2px solid #e2e8f0",
                        ...
                        cursor: isAISolving ? "not-allowed" : "pointer",
                        fontWeight: 600,
                        fontSize: isDesktop ? "15px" : "clamp(11px, 2.8vw, 13px)", // 🔥 BIGGER!
                        color: notesMode ? "white" : "#4a5568",
                        opacity: isAISolving ? 0.5 : 1,
                        touchAction: "manipulation",
                        minHeight: isDesktop ? "56px" : "48px", // 🔥 TALLER!
                        display: "flex",
                        flexDirection: "column",
                        alignItems: "center",
                        justifyContent: "center",
                ...
                >
                    <span style={{ fontSize: isDesktop ? "20px" : "18px" }}>✏️</span> {/* 🔥 BIGGER ICON! */}
                    <span style={{ fontSize: isDesktop ? "11px" : "clamp(9px, 2.2vw, 10px)" }}>
                        Notes
                    </span>
                </button>
                ...
                >
                    <span style={{ fontSize: isDesktop ? "20px" : "18px" }}>{isPaused ? "▶️" : "⏸️"}</span>
                    <span style={{ fontSize: isDesktop ? "11px" : "clamp(9px, 2.2vw, 10px)" }}> {/* 🔥 BIGGER! */}
                ...
                >
                    <span style={{ fontSize: isDesktop ? "20px" : "18px" }}>💡</span>
                    <span style={{ fontSize: isDesktop ? "11px" : "clamp(9px, 2.2vw, 10px)" }}> {/* 🔥 BIGGER! */}
                        {rules.hints === 0
                            ? "None"
                            : hintsRemaining === 0
                ...
                >
                    <span style={{ fontSize: isDesktop ? "20px" : "18px" }}>🎮</span>
                    <span style={{ fontSize: isDesktop ? "11px" : "clamp(9px, 2.2vw, 10px)" }}>New</span> {/* 🔥 BIGGER! */}
                </button>
            </div>
        </>
    )
